...
from ryomakaraoke.lib.library_scanner import LibraryScanner, ScanResult
from ryomakaraoke.lib.network import get_ip
from ryomakaraoke.lib.playback_controller import PlaybackController
...
from ryomakaraoke.version import __version__ as VERSION
...
class Karaoke:
    ...
    def __init__(
        ...
        logging.info("ryomakaraoke version: " + VERSION)
    ...
    def get_url(self):
        """Get the URL for accessing the ryomakaraoke web interface.
    ...
    def run(self) -> None:
        ...
        """
        logging.debug("Starting ryomakaraoke run loop")
