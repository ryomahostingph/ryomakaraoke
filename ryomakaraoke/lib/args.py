...
from ryomakaraoke.lib.get_platform import get_default_dl_dir, get_platform
...
def parse_ryomakaraoke_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--limit-user-songs-by",
        help=f"Limit the number of songs a user can add to queue. User name 'ryomakaraoke' is always unlimited (default: {_DEFAULTS['limit_user_songs_by']} = unlimited)",
        default=None,
        required=False,
    )
    parser.add_argument(
