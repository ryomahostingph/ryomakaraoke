...
from ryomakaraoke.lib.youtube_dl import upgrade_youtubedl
...
from ryomakaraoke.routes.metadata_api import metadata_bp
...
from ryomakaraoke.routes.socket_events import setup_socket_events
...
app.config["API_TITLE"] = "ryomakaraoke API"
...
def main() -> None:
    ...
    # log_path = os.path.join(get_data_directory(), 'ryomakaraoke.log')
    ...
    from ryomakaraoke.lib.current_app import broadcast_event
