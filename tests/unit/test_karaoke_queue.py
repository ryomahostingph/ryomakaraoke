...
class TestEnqueue:
    ...
    def test_enqueue_user_limit_not_applied_to_ryomakaraoke(self, mock_karaoke):
        """Test that ryomakaraoke user bypasses song limit."""
        mock_karaoke.preferences.set("limit_user_songs_by", 1)

        mock_karaoke.queue_manager.enqueue("/songs/song1---abc.mp4", "ryomakaraoke")
        result = mock_karaoke.queue_manager.enqueue("/songs/song2---def.mp4", "ryomakaraoke")
